(function(){
	angular
		.module('BarTindrApp')
		.controller('DrinkController', ['$http', '$scope', '$q', '$ionicLoading', '$ionicActionSheet', DrinkController]);

	function DrinkController($http, $scope, $q, $ionicLoading, $ionicActionSheet) {
